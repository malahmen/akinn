...
ERR_FCC="Failed to generate containerd configuration."
ERR_FGT="Failed to generate the join token."
ERR_FGH="Failed to generate the discovery token CA certificate hash."
...
ERR_PFNS="LOGIN file path is not set."
ERR_PFNE="LOGIN file does not exist."